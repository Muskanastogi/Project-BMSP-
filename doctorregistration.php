...
$to=$_POST['email'];
$number=$_POST['number'];
$patientfee=$_POST['special'];
$specialization=$_POST['pfee'];
$city=$_POST['city'];
$schedule=$_POST['sch'];
$from=$_POST['from'];
$to=$_POST['to'];
...
else
{
	...
	$sql= " INSERT INTO `doctorpassword` (`id`,`dname`, `dpassword`) VALUES ('$idd','$usernamedr','$passworddr')";
mysqli_query($conn,$sql );

}

$lll = "INSERT INTO doctorinformation(id,firstname,lastname,add1,add2,firmno,license,email,connumber,feepatient,specilization,city,schedule,f,t)
 VALUES('$idd','$usernamedr','$la','$address','$localaddress','$firm','$licence','$to','$number','$patientfee','$specialization','$city','$schedule','$from','$to')";
